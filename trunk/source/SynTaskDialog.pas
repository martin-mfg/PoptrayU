...
procedure TSynTaskDialog.SetElementText(element: TTaskDialogElement; const Text: string);
...
procedure TSynTaskDialog.AddButton(const ACaption: string; const ACommandLinkHint: string = '');
begin
  if Buttons <> '' then
